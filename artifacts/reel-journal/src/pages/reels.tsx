        ...
        <div className="flex items-center gap-2 bg-card border rounded-md p-1">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="plays-desc">Most Plays</SelectItem>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {data?.reels.map((reel, i) => (
            <Link key={reel.id} href={`/reels/${reel.id}`}>
              <Card className="overflow-hidden bg-card hover:border-primary/50 transition-colors group cursor-pointer h-full flex flex-col hover-elevate">
