                ...
                {isPlaying ? (
                  ...
                  <>
                    ...
                    <div className="absolute top-2 left-2 flex flex-col gap-1">
                      {/* Platform badge */}
                      {ref.url?.includes("tiktok.com") ? (
                        <div className="bg-black/70 rounded-full px-1.5 py-0.5 flex items-center gap-0.5">
                          <svg className="w-2.5 h-2.5" viewBox="0 0 24 24" fill="white"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.78a4.85 4.85 0 0 1-1.01-.09z"/></svg>
                          <span className="text-[8px] font-bold text-white leading-none">TT</span>
                        </div>
                      ) : ref.url?.includes("instagram.com") ? (
                        <div className="bg-linear-to-br from-purple-500 via-pink-500 to-orange-400 rounded-full p-1">
